...
const Hero = () => {
    ...
    return (
        ...
        className='h-full flex flex-col items-center justify-center gap-14 bg-light text-center'>
            <motion.h1
             initial={{y: 50, opacity: 0}}
            animate={{y:0, opacity: 1}}
            transition={{duration: 0.5, delay: 0.2}}
            className='text-4xl md:text-5xl font-semibold mt-5'>Luxury car on rent</motion.h1>
            <motion.form 
    ...
    <div className='flex flex-col md:flex-row items-start md:items-center gap-10 min-md:ml-8'>
        <div className='flex flex-col items-start gap-2'>
              ...
              <p className='px-1 text-sm text-gray-500'>{pickupLocation ? pickupLocation : 'Plese select your location'}</p>
          </div>
          <div className='flex flex-col items-start gap-2'>
       ...
       src={assets.main_car} alt="car" className='' />
    </motion.div>
