...
const Banner = () => {
  return (
    ...
    className='flex flex-col md:flex-row items-center md:items-start justify-between px-8 min-md:pl-14 pt-10
    ...
    <div className='text-white'>
        ...
        <p className='max-w-130'>We take care of insurance, driver verification and secure payment - so you can earn
